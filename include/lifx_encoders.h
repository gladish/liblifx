//
// DO NOT EDIT - AUTO-GENERATE:2020-02-07 15:15:32.048154
//
...
int lifxDecoder_DecodeDeviceGetService(lifxDeviceGetService_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeDeviceStateService(lifxDeviceStateService_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeDeviceGetHostInfo(lifxDeviceGetHostInfo_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeDeviceStateHostInfo(lifxDeviceStateHostInfo_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeDeviceGetHostFirmware(lifxDeviceGetHostFirmware_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeDeviceStateHostFirmware(lifxDeviceStateHostFirmware_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeDeviceGetWifiInfo(lifxDeviceGetWifiInfo_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeDeviceStateWifiInfo(lifxDeviceStateWifiInfo_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeDeviceGetWifiFirmware(lifxDeviceGetWifiFirmware_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeDeviceStateWifiFirmware(lifxDeviceStateWifiFirmware_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeDeviceGetPower(lifxDeviceGetPower_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeDeviceSetPower(lifxDeviceSetPower_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeDeviceStatePower(lifxDeviceStatePower_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeDeviceGetLabel(lifxDeviceGetLabel_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeDeviceSetLabel(lifxDeviceSetLabel_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeDeviceStateLabel(lifxDeviceStateLabel_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeDeviceGetVersion(lifxDeviceGetVersion_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeDeviceStateVersion(lifxDeviceStateVersion_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeDeviceGetInfo(lifxDeviceGetInfo_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeDeviceStateInfo(lifxDeviceStateInfo_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeDeviceAcknowledgement(lifxDeviceAcknowledgement_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeDeviceGetLocation(lifxDeviceGetLocation_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeDeviceSetLocation(lifxDeviceSetLocation_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeDeviceStateLocation(lifxDeviceStateLocation_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeDeviceGetGroup(lifxDeviceGetGroup_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeDeviceSetGroup(lifxDeviceSetGroup_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeDeviceStateGroup(lifxDeviceStateGroup_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeDeviceEchoRequest(lifxDeviceEchoRequest_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeDeviceEchoResponse(lifxDeviceEchoResponse_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeLightGet(lifxLightGet_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeLightSetColor(lifxLightSetColor_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeLightSetWaveformOptional(lifxLightSetWaveformOptional_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeLightSetWaveform(lifxLightSetWaveform_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeLightGetPower(lifxLightGetPower_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeLightSetPower(lifxLightSetPower_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeLightStatePower(lifxLightStatePower_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeLightState(lifxLightState_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeLightGetInfrared(lifxLightGetInfrared_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeLightStateInfrared(lifxLightStateInfrared_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeLightSetInfrared(lifxLightSetInfrared_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeTileGetDeviceChain(lifxTileGetDeviceChain_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeTileStateDeviceChain(lifxTileStateDeviceChain_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeTileSetUserPosition(lifxTileSetUserPosition_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeTileGet64(lifxTileGet64_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeTileState64(lifxTileState64_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeTileSet64(lifxTileSet64_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeTileGetEffect(lifxTileGetEffect_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeTileSetEffect(lifxTileSetEffect_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeTileStateEffect(lifxTileStateEffect_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeMultiZoneSetColorZones(lifxMultiZoneSetColorZones_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeMultiZoneGetColorZones(lifxMultiZoneGetColorZones_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeMultiZoneStateZone(lifxMultiZoneStateZone_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeMultiZoneStateMultiZone(lifxMultiZoneStateMultiZone_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeMultiZoneGetEffect(lifxMultiZoneGetEffect_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeMultiZoneSetEffect(lifxMultiZoneSetEffect_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeMultiZoneStateEffect(lifxMultiZoneStateEffect_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeMultiZoneExtendedSetColorZones(lifxMultiZoneExtendedSetColorZones_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeMultiZoneExtendedGetColorZones(lifxMultiZoneExtendedGetColorZones_t* pkt, lifxBuffer_t const* buff);
int lifxDecoder_DecodeMultiZoneExtendedStateMultiZone(lifxMultiZoneExtendedStateMultiZone_t* pkt, lifxBuffer_t const* buff);

int lifxEncoder_EncodeLightHsbk(lifxLightHsbk_t const* pkt, lifxBuffer_t* buff);
int lifxDecoder_DecoderLightHsbk(lifxLightHsbk_t* pkt, lifxBuffer_t const* buff);
int lifxEncoder_EncodeMultiZoneEffectParameter(lifxMultiZoneEffectParameter_t const* pkt, lifxBuffer_t* buff);
int lifxDecoder_DecoderMultiZoneEffectParameter(lifxMultiZoneEffectParameter_t* pkt, lifxBuffer_t const* buff);
int lifxEncoder_EncodeMultiZoneEffectSettings(lifxMultiZoneEffectSettings_t const* pkt, lifxBuffer_t* buff);
int lifxDecoder_DecoderMultiZoneEffectSettings(lifxMultiZoneEffectSettings_t* pkt, lifxBuffer_t const* buff);
int lifxEncoder_EncodeTileAccelMeas(lifxTileAccelMeas_t const* pkt, lifxBuffer_t* buff);
int lifxDecoder_DecoderTileAccelMeas(lifxTileAccelMeas_t* pkt, lifxBuffer_t const* buff);
int lifxEncoder_EncodeTileStateDevice(lifxTileStateDevice_t const* pkt, lifxBuffer_t* buff);
int lifxDecoder_DecoderTileStateDevice(lifxTileStateDevice_t* pkt, lifxBuffer_t const* buff);
int lifxEncoder_EncodeTileBufferRect(lifxTileBufferRect_t const* pkt, lifxBuffer_t* buff);
int lifxDecoder_DecoderTileBufferRect(lifxTileBufferRect_t* pkt, lifxBuffer_t const* buff);
int lifxEncoder_EncodeTileEffectParameter(lifxTileEffectParameter_t const* pkt, lifxBuffer_t* buff);
int lifxDecoder_DecoderTileEffectParameter(lifxTileEffectParameter_t* pkt, lifxBuffer_t const* buff);
int lifxEncoder_EncodeTileEffectSettings(lifxTileEffectSettings_t const* pkt, lifxBuffer_t* buff);
int lifxDecoder_DecoderTileEffectSettings(lifxTileEffectSettings_t* pkt, lifxBuffer_t const* buff);
